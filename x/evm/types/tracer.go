...
// EVM transaction.
func NewTracer(tracer string, msg *core.Message, cfg *params.ChainConfig, height int64, blocktime time.Time) vm.EVMLogger {
	...
	case TracerAccessList:
		preCompiles := vm.ActivePrecompiles(cfg.Rules(big.NewInt(height), cfg.MergeNetsplitBlock != nil, uint64(blocktime.Unix())))
